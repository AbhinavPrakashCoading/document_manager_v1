...
const GuestMode: React.FC<GuestModeProps> = ({
  ...
  const exams: ExamType[] = [
    ...
    },
    {
      id: 'cat',
      name: 'CAT',
      description: 'Common Admission Test for management programs',
      icon: <GraduationCap />,
      category: 'entrance'
    },
    {
  ...
  const handleExamSelect = (examId: string) => {
    ...
    setTimeout(() => {
      ...
      // Navigate to upload page with exam type
      setTimeout(() => {
        router.push(`/upload/${examId}`)
      }, 300)
    }, 150)
  }
...
// Usage example with your app structure:
/*
